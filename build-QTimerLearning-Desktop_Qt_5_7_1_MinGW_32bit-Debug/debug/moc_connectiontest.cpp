...
#include "../../QTimerLearning/connectiontest.h"
...
QT_MOC_LITERAL(1, 15, 7), // "nothing"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "ConnectionTest\0nothing\0"
};
...
void ConnectionTest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ConnectionTest *_t = static_cast<ConnectionTest *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->nothing(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ConnectionTest::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ConnectionTest.data,
      qt_meta_data_ConnectionTest,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ConnectionTest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ConnectionTest.stringdata0))
        return static_cast<void*>(const_cast< ConnectionTest*>(this));
